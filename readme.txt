...
= 1.1.4 =
* Changed the name from Super Stripe to Buy Now for Stripe
...
= 1.1.4 =
* No need to upgrade to this release. No new features, just changed the name of the plugin & service to Buy Now for Stripe
